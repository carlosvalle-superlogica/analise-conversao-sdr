...
if not st.session_state['autenticado']:
    ...
    try:
        ...
        # ==============================================================================
        # BARRA LATERAL - BOTÃO MASTER (PIPELINES) E NAVEGAÇÃO
        # ==============================================================================
        st.sidebar.markdown("<h2 style='color: #1565C0; font-size: 20px;'>Pipeline Principal</h2>", unsafe_allow_html=True)
        
        # O "Botão Master" que alterna as Unidades de Negócio
        pipeline_selecionado = st.sidebar.selectbox(
            "Selecione a Unidade",
            ["Aquisições", "Canais"],
        ...
        # ==============================================================================
        # LÓGICA BLINDADA - DASHBOARD GERAL (CONTEÚDO POR PIPELINE)
        # ==============================================================================
