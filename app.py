...
if not st.session_state['autenticado']:
    ...
    try:
        ...
        # --- CÁLCULO BRUTO DO TMA E DA PERSISTÊNCIA (Isolado da Máscara de Página) ---
        ...
        if pipeline_sel == "Aquisições":
            ...
            # --------------------------------------------------------------------------
                ...
                # TMA (MEDIANA): calculado focado estritamente na coorte de criação do período selecionado
                ...
                # PERMANÊNCIA (MÉDIA): apenas leads que foram perdidos NO PERÍODO e por "Sem contato"
                ...
                ct1.metric(
                    ...
                    "Calculado apenas para os Leads criados no período",
                    delta_color="off"
                )
                ct2.metric(
